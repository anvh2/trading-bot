...
func TestListPositionRisk(t *testing.T) {
	resp, err := test_binanceInst.ListPositionRisk(context.Background(), "BTCUSDT")
	assert.Nil(t, err)
...
func TestListOpenOrders(t *testing.T) {
	resp, err := test_binanceInst.ListOpenOrders(context.Background(), "BTCUSDT")
	assert.Nil(t, err)
...
func TestCreateOrders(t *testing.T) {
	resp, err := test_binanceInst.CreateOrders(context.Background(), []*models.Order{
		{
			Symbol:           "BNXUSDT",
