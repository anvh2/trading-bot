...
type Market struct {
	Name           string `json:"name,omitempty"`           //Represents the name of the market as defined in general (e.g. ETH-BTC).
...
type MarketSummary struct {
	High   decimal.Decimal `json:"high"`   //Represents the 24 hours maximum peak of this market.
	Low    decimal.Decimal `json:"low"`    //Represents the 24 hours minimum peak of this market.
	Volume decimal.Decimal `json:"volume"` //Represents the 24 volume peak of this market.
	Ask    decimal.Decimal `json:"ask"`    //Represents the current ASK value.
	Bid    decimal.Decimal `json:"bid"`    //Represents the current BID value.
	Last   decimal.Decimal `json:"last"`   //Represents the value of the last trade.
}
